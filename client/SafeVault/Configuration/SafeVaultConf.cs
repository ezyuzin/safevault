...
namespace SafeVault.Configuration
{
    internal sealed class SafeVaultConf
    {
        ...
        public void Save()
        {
            ...
            {
                throw new SafeVaultConfException(e, "Unable to save settings into PwDatabase:\n" + e.Message);
            }
            ...
            {
                throw new SafeVaultConfException(e, "Unable to save local config:" + _localFilename + "\n" + e.Message);
            }
        }
        ...
        {
            if (_pwDatabase == null)
                throw new SafeVaultConfException("Unable to save setting. PwDatabase not setted");

            if (!_pwDatabase.IsOpen)
                throw new SafeVaultConfException("Unable to save setting. PwDatabase not opened");
