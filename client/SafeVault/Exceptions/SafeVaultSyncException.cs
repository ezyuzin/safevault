...
{
    public class SafeVaultSyncException : SafeVaultException
    {
        public SafeVaultSyncException(System.Exception inner, string message, params object[] args)
            : base(args.Length == 0 ? message : string.Format(message, args), inner)
        {
        }

        public SafeVaultSyncException(string message, params object[] args)
