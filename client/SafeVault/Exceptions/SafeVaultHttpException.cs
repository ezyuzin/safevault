...
{
    public class SafeVaultHttpException : SafeVaultException
    {
        public HttpStatusCode StatusCode { get; set; }

        public SafeVaultHttpException(System.Exception inner, string message, params object[] args)
            : base(args.Length == 0 ? message : string.Format(message, args), inner)
        {
        }

        public SafeVaultHttpException(string message, params object[] args)
